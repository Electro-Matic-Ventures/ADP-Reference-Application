...
if TYPE_CHECKING:
    ...
    from DefaultElement import DefaultElement


class AddDefaultElement(Button):

    def __init__(self, app:"MainWindow", host:"DefaultElement"):
        super().__init__()
        self.app: "MainWindow" = app
        self.host: "DefaultElement" = host
        self.button: QPushButton = self.__button()
