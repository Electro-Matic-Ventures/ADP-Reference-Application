...
class SetTimeFormat(Tile):
    ...
    def __init__(self, app: "MainWindow", host: "SignSettings"):
        ...
        self.constructed_element.set_text(TIME_FORMAT["24 hour"])
    ...
    def _value(self):
        ...
        select_box.addItems(TIME_FORMAT)
        select_box.setCurrentText("24 hour")
