...
class ElementOptionValue(Tile):
    
    def __init__(self, app:"MainWindow", host:"SegmentElement", option_type):
        super().__init__()
    ...
    def _value(self, option_type):
        ...
        select_box.hide()
        select_box.addItems(OPTION_CODES[option_type]["values"].keys())
        select_box.setCurrentText("normal_5")
