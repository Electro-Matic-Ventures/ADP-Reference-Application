...
from CONSTANTS import ADDRESS_MODES
...
class AddressMode(Tile):
    ...
    def _value(self):
        ...
        select_box.hide()
        select_box.addItems(ADDRESS_MODES)
        ...
        select_box.currentIndexChanged.connect(self.host.select_address_layout)
        return select_box
